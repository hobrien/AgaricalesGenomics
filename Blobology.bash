...
do
  ...
  if ! test -f Blobology/${species}_10000.bl
  then
  ...
  if test -f Reads/${species}_1.fastq && test -f Reads/${species}_2.fastq && ! test -f Blobology/${species}.bam
  then
  ...
  if test -f Blobology/${species}.bam && ! test -f Blobology/${species}_blob.txt
  then
